...
('978-84-666-5766-2', 'BRANDON SANDERSON', 'EL CAMINO DE LOS REYES', 'FANTASIA', 'Anhelo los días previos a la Última Desolación. Los días en que los Heraldos nos abandonaron y los Caballeros Radiantes se giraron en nuestra contra. Un tiempo en que aún había magia en el mundo y honor en el corazón de los hombres. El mundo fue nuestro, pero lo perdimos. Probablemente no hay nada más estimulante para las almas de los hombres que la victoria.', 'elcaminodelosreyes.png', 2012, '5.00'),
...
('9788491670155', 'KENTARO MIURA', 'BERSERK MAXIMUN 1', 'COMIC&MANGA', 'Edición de lujo de una de las más aclamadas series manga de todos los tiempos. Un viaje épico y salvaje a un reino de fantasía. Guts es un guerrero vestido de negro de los pies a la cabeza que porta una gigantesca espada más larga que su propia estatura y un robusto brazo ortopédico de hierro', 'berserkmaximun.jpg', 1987, '5.00');
