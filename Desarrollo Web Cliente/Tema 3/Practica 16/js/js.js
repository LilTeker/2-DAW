...
let disco = [   
    {disco: "El Círculo", cantante: "Kase.O", año: "2016", tipoMusica: "rock", localizacion: "02", prestado: "false"},
    {disco: "Cara y Cruz", cantante: "Ayax", año: "2018", tipoMusica: "rap", localizacion: "01", prestado: "true"},
    {disco: "Agujeros de Gusano", cantante: "Izal", año: "2013", tipoMusica: "indie", localizacion: "", prestado: "false"}
];

localStorage.setItem("discosDefault", JSON.stringify(disco));
...
function resetContr() {
    disco = JSON.parse(localStorage.getItem("discosDefault"));
...
function indexView(discos) {
    ...
    return html + `</ul> <button id="new">Crear</button> <button id="reset">Reiniciar</button>`;
};
...
document.addEventListener("click", evento => {
    ...
    else if (evento.target.matches('#reset')) resetContr();
});